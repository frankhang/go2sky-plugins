...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "  Data do_transfer(Data data)")
	fmt.Fprintln(os.Stderr, "  Data do_format(Data data)")
	fmt.Fprintln(os.Stderr, "  Data do_bracket(Data data)")
	fmt.Fprintln(os.Stderr)
	os.Exit(0)
}
...
func main() {
	...
	case "do_transfer":
		if flag.NArg()-1 != 1 {
			fmt.Fprintln(os.Stderr, "DoTransfer requires 1 args")
			flag.Usage()
		}
		arg8 := flag.Arg(1)
		...
		value0 := argvalue0
		fmt.Print(client.DoTransfer(context.Background(), value0))
		fmt.Print("\n")
		break
	case "do_format":
		if flag.NArg()-1 != 1 {
	...
	case "do_bracket":
		if flag.NArg()-1 != 1 {
			fmt.Fprintln(os.Stderr, "DoBracket requires 1 args")
			flag.Usage()
		}
		arg20 := flag.Arg(1)
		...
		value0 := argvalue0
		fmt.Print(client.DoBracket(context.Background(), value0))
		fmt.Print("\n")
		break
	case "":
		Usage()
